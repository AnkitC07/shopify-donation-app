import { Button, DataTable, Divider, FullscreenBar, HorizontalStack, LegacyCard, Page, Pagination, Select, Text } from '@shopify/polaris'
                ...
                <Page fullWidth>
                    ...
                    <div className="Compensations_table" style={{ margin: '40px 0px', }}>
                        <div className="header_table" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                            ...
                            <div className='col-sm-4' style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap' }}>
