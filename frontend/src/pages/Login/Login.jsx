...
import { Button, InlineError, Text, TextField, VerticalStack } from '@shopify/polaris';
import './index.css'
...
function Login() {
    ...
    return (
        <div id='super-admin-login' style={{ maxWidth: '500px', margin: 'auto', textAlign: "center" }}>
            <VerticalStack gap="10">
                ...
                <VerticalStack gap="5">
                    ...
                    <div style={{ textAlign: 'right' }}>
                        <Button loading={loading} size='large' primary onClick={handleLogin}>Login</Button>
                    </div>
                </VerticalStack>
            </VerticalStack>
        </div>
