                        ...
                        >
                            <div
                                ...
                                style={{
                                    ...
                                    alignItems: "center",
                                    gap: 10,
                                    border: `1px solid ${design["border-color"]}`,
                                    padding: "10px 15px",
                                    background: "#fff",
                            ...
                            >
                                ...
                                <div style={{ marginRight: 15 }}>
                                    ...
                                    >
                                        ...
                                        <div className="tooltip">
                                            ...
                                            <span className="tooltiptext">
                                                By reducing the carbon footprint of your purchase, <b> 100% </b> of your
                                                compensation is used to finance tree planting projects near you. Want to
                                                know more? Read through our process with full transparency and track our
                                                live climate mitigation projects at{" "}
                                                <span style={{ color: "#56B280" }}> www.emissa.eu.</span>
                                            </span>
                                        </div>
                                    </div>
                                    <p
                                    ...
                                    >
                                        Offset 1.62 kg CO2 with <span style={{ color: "#53964D" }}>Emissa</span>
                                    </p>
                                </div>
                                <div className="check_custom" style={{ display: "flex", alignItems: "center" }}>
                ...
                <LegacyCard.Section>
                    <VerticalStack gap="8">
                        ...
                        <VerticalStack gap="2">
                            ...
                            <HorizontalStack gap="1" wrap={false}>
                                ...
                                <div className="styleInput" style={{ width: "100%" }}>
                                    <TextField
                                        placeholder="default"
                                        value={design["border-color"]?.replace("#", "")}
                                        onChange={(e) => {
                                            setDesign({
                                                ...design,
                                                "border-color": "#" + e,
                        ...
                        <HorizontalStack align="end">
                            <ButtonGroup>
                                <Button loading={isLoadingCancle} onClick={() => handleCancle()}>
                                    Cancel
                                </Button>
                                <Button loading={isLoadingSave} primary onClick={() => handleSave()}>
                                    Save
                                </Button>
                            </ButtonGroup>
                        </HorizontalStack>
